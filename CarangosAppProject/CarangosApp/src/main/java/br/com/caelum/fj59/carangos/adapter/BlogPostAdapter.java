...
public class BlogPostAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        //UrlImageViewHelper.setUrlDrawable(foto, blogPost.getFoto(), this.context.getResources().getDrawable(R.drawable.loading));
        Picasso.with(context).load(blogPost.getFoto()).placeholder(this.context.getResources().getDrawable(R.drawable.loading)).error(this.context.getResources().getDrawable(R.drawable.ic_erro)).into(holder.foto);
